            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return _buildPizzaCard(
                  ...
                  pizza['imageUrl'] ?? 'https://via.placeholder.com/200', // URL de imagen de respaldo si no se proporciona una
                  pizza['descripcion'] ?? 'Descripción no disponible',
                  pizza['precio'] != null ? pizza['precio'].toString() : 'Precio no disponible', // Convierte el precio en cadena si está presente
                );
              },
            );
          }
